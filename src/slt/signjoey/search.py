...
def beam_search(
    ...
    for step in range(max_output_length):
        ...
        # Prediction fails at line 366 as follows
        # 366: [alive_seq.index_select(0, select_indices), topk_ids.view(-1, 1)], -1
        # Error: RuntimeError: "index_select_out_cuda_impl" not implemented for 'Float'     
        # This is the closest issue I found related to the error, 
        # which indicates division problem. So trying it out
